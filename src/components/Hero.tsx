...
export const Hero = () => {
    return (
        <div className="flex flex-col items-start justify-center h-screen w-screen px-4 lg:px-40">
            <Aurora colorStops={["#ca9ee6", "#303446", "#ca9ee6"]} className="absolute top-0 left-0 w-screen h-screen" />
            ...
            >
                <motion.div
                    className="flex text-center font-normal text-lg lg:text-4xl lg:text-left"
                    variants={item}
                >
                    <p>
                        Albert is a software engineer with <span className="text-[#ca9ee6]">5+ years experience</span> building production applications
                    </p>
                </motion.div>
